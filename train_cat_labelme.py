...
def parse_arguments():
    ...
    parser.add_argument('--brightness_min', type=float, default=0.35, help='Minimum brightness factor')
    parser.add_argument('--brightness_max', type=float, default=1.1, help='Maximum brightness factor')
    parser.add_argument('--contrast_min', type=float, default=0.65, help='Minimum contrast factor')
