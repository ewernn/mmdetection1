...
def parse_arguments():
    ...
    parser.add_argument('--brightness_min', type=float, default=0.36, help='Minimum brightness factor')
    parser.add_argument('--brightness_max', type=float, default=1.1, help='Maximum brightness factor')
    parser.add_argument('--contrast_min', type=float, default=0.69, help='Minimum contrast factor')
    parser.add_argument('--contrast_max', type=float, default=1.58, help='Maximum contrast factor')
